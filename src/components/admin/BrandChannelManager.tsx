...
export default function BrandChannelManager({ brand, metaMappings, naverMappings, ga4Mappings }: Props) {
            ...
            {ga4Connected === false && (
              <div className="mt-1 space-y-2">
                <a
                  ...
                  className="inline-flex items-center gap-2 px-3 py-2 text-xs font-medium text-white bg-orange-500 hover:bg-orange-600 rounded-lg transition"
                >
                ...
                <button onClick={() => setGa4ManualMode(true)} className="block text-[10px] text-slate-400 hover:text-slate-600">
                  직접 입력하기 →
                </button>
              </div>
            )}
